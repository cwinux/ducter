...
class DcmdNodeController extends Controller
{
    ...
    public function actionNodeInfo() {
       $ret_msg = '<table class="table table-striped table-bordered"><tbody>';
       $output_array = array();
       $url = "http://lingshu-test.letv.cn/cmdb/cmdbapi/getvminfo?ip=10.154.21.11&link_token=17a710902c1e356bc718136a3b854d63";
       //$data = array (
       // 'ip' => '10.154.21.11',
       ...
       $ret_msg .="<tr><td width='300'>服务器ip</td><td>".$output_array['code']."</td></tr>";   
       $ret_msg .="<tr><td>主机名</td><td>".$output_array['code']."</td></tr>"; 
       $ret_msg .="<tr><td>资产序列号</td><td>".$output_array['code']."</td></tr>";  
       $ret_msg .="<tr><td>设备序列号</td><td>".$output_array['code']."</td></tr>";
       $ret_msg .="<tr><td>机房</td><td>".$output_array['code']."</td></tr>";  
       $ret_msg .="<tr><td>机架</td><td>".$output_array['code']."</td></tr>";
       $ret_msg .="<tr><td>上线时间</td><td>".$output_array['code']."</td></tr>";
       $ret_msg .="<tr><td>采购时间</td><td>".$output_array['code']."</td></tr>";
       $ret_msg .="<tr><td>维保时间</td><td>".$output_array['code']."</td></tr>";  
       $ret_msg .="<tr><td>内存信息</td><td>".$output_array['code']."</td></tr>";
       $ret_msg .="<tr><td>CPU信息</td><td>".$output_array['code']."</td></tr>";
       $ret_msg .="<tr><td>磁盘信息</td><td>".$output_array['code']."</td></tr>";    
       $ret_msg .="<tr><td>创建时间</td><td>".$output_array['code']."</td></tr>";
       $ret_msg .="<tr><td>修改时间</td><td>".$output_array['code']."</td></tr>";
       $ret_msg .= "</tbody></table>";
       print_r($ret_msg);
    }
    ...
    public function actionCreate($ngroup_id)
    {
        ...
        $model = new DcmdNode();
        $devtype_query = DcmdNodeGroupInfo::find()->andWhere(['type'=>'设备类型'])->asArray()->all();
        $dev_type = array();
        foreach($devtype_query as $item) {
          $dev_type[$item['id']] = $item['name'];
        }
