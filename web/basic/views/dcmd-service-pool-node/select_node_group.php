...
<form id="w0" action="<?php echo Url::to(['show-node-list','app_id'=>$app_id, 'svr_id'=>$svr_id, 'svr_pool_id'=>$svr_pool_id]); ?>" method="post">
<div class="dcmd-service-pool-node-index">
    ...
    <?= GridView::widget([
        ...
        'columns' => [
            ...
            array('attribute'=>'ngroup_id','label'=>'设备池子', 'value'=>function($model, $key, $index, $column) { return $model->getGroup($model['ngroup_id']);},),
        ],
    ]); ?>
