...
<div class="dcmd-service-index">
    ...
    <?= GridView::widget([
        ...
        'columns' => [
            ...
            array('attribute'=>'app_name', 'label'=>'产品名称', 'enableSorting'=>false, 'content' => function($model, $key, $index, $column) { return Html::a($model->getAppName($model['app_id']), Url::to(['dcmd-app/view', 'id'=>$model['app_id']]));}),
