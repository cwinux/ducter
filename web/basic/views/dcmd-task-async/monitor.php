...
<tr><td>软件版本:</td><td><?php echo $task->tag; ?></td></tr>
<tr><td>版本md5:</td><td><?php echo $task->tag_md5; ?></td></tr>
<tr><td>是否上线任务:</td><td><?php if($task->is_deploy == 0) echo "否"; else if($task->is_deploy == 1) echo "是"; ?></td></tr>
<tr><td>更新配置:</td><td><?php if($task->update_env == 0) echo "否"; else if($task->update_env == 1) echo "是"; ?></td></tr>
<tr><td>更新软件版本:</td><td><?php if($task->update_tag == 0) echo "否"; else if($task->update_env == 1) echo "是"; ?></td></tr>
...
<script src="./assets/62ffd36d/jquery.js"></script>
<script src="./assets/1353ee06/yii.js"></script>
<script>
///获取服务池子信息
var hitCount=1;
