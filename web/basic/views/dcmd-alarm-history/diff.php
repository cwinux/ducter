...
<ul class="codeDemoUL" id="ulMenu">
  <li class="codeDemomouseOnMenu" id="dcmd-node-l" onclick="showDiv('dcmd-node');this.className='codeDemomouseOnMenu'">规格不一致</li>
  <li class="codeDemomouseOutMenu" id="dcmd-run-task-l" onclick="showDiv('dcmd-run-task');this.className='codeDemomouseOnMenu'"></li>
  ...
  <li class="codeDemomouseOutMenu" id="dcmd-app-l" onclick="showDiv('dcmd-vm-info');this.className='codeDemomouseOnMenu'">虚拟机信息</li>
</ul>
