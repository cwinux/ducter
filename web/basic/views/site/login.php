...
<head>
<style type="text/css">
body {background-image:url(/ducter/css/back.png);}
</style>
    <meta charset="<?= Yii::$app->charset ?>"/>
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta name="csrf-param" content="_csrf">
    <title><?= Html::encode($this->title) ?></title>
    <link href="/ducter/css/log.css" rel="stylesheet">
</head>
...
<DIV class=login-btn><INPUT id=login-btn value="登 录" type=submit name=submit></DIV>
    <?php ActiveForm::end(); ?>
<DIV id=login-copyright>2017 apollo <A href="/" target=_blank>www.ducter.net</A> </DIV>
</body>
</html>
