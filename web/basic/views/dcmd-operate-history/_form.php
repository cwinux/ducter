...
<div class="dcmd-alarm-form">

    <?php $form = ActiveForm::begin(); ?>
    <?= $form->field($model, 'fault_id')->textInput(['maxlength' => 128])->label('故障ID') ?>
    ...
    <?= $form->field($model, 'start_time')->textInput(['maxlength' => 32, 'value' => '时间格式：2017-01-01 14:30:20', 'onfocus' => 'this.value=""'])->label('开始时间') ?>

    <?= $form->field($model, 'is_confirm')->textInput(['maxlength' => 1])->label('是否确认') ?>

    <?= $form->field($model, 'confirm_time')->textInput(['maxlength' => 32, 'value' => '时间格式：2017-01-01 14:30:20', 'onfocus' => 'this.value=""'])->label('确认时间') ?>
 
    <?= $form->field($model, 'erase_time')->textInput(['maxlength' => 32, 'value' => '时间格式：2017-01-01 14:30:20', 'onfocus' => 'this.value=""'])->label('处理时间') ?>
