   ...
   ?>
    <?= GridView::widget([
        ...
        'columns' => [
            ...
            array('attribute'=>'vm_fault', 'label'=>'故障信息', 'enableSorting'=>false),
            ...
            ['class' => 'yii\grid\ActionColumn','template'=>'{view}', 'urlCreator'=>function($action, $model, $key, $index) {return Url::to(['dcmd-fault/view','id'=>$model['fault_id']]);}, "visible"=>(Yii::$app->user->getIdentity()->admin == 1) ? true : false],
        ],
