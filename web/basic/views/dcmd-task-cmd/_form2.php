...
<div class="dcmd-task-cmd-form">
    ...
    <?= $form->field($model, 'task_cmd')->textInput(['maxlength' => 64, $model->task_cmd ? "disabled" : "" =>true ,'onblur' => "javascript:getTaskScriptContent()"])->label('脚本名称') ?>
    <p>
    ...
    <?= $form->field($model, 'is_deploy')->dropDownList([1=>'是',0=>'否'])->label('是否上线脚本') ?>
