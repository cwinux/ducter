...
<div class="dcmd-fault-index">
   ...
   ?>
    <p>
        <input type="button" class="btn btn-sucess" ="display:none" style="background:#00BB00;color:white" value="添加行" onclick="addRow();"/>
        <input type="button" class="btn btn-sucess" ="display:none" style="background:#00BB00;color:white" value="保存" onclick="saveRow();"/>
...
<script type="text/javascript">
  ...
  function test(x) {
    ...
    $.get(url, {fault_id:id}, function(data){ 
      ...
      $('#faltItems').html(tab);
      $('#myModal').modal('show');
      if(data.split("</table>")[1]=="报修") document.getElementById("step2").className = "step-start step-done";
