...
<div class="dcmd-fault-index">
   ...
   ?>
   <label style="font-family:宋体; font-size:13px;">集群名称:</label>
   ...
   <label style="font-family:宋体; font-size:13px;">规格:</label>
   <select id="flavor" style="width:80px;margin-left:7px;">
     <option value="ALL">ALL</option>
     <?php
   ...
   <label style="font-family:宋体; font-size:13px;">状态:</label>
   <select id="state" style="width:80px;margin-left:7px;">
     <option value="ALL">ALL</option>
...
<script language="JavaScript" type="text/javascript">
  function search_app() {
    ...
    var url = "/index.php?r=dcmd-vm-report/get-app";
    $.get(url, {"state":state, "flavor":flavor, "app":app}, function(data, status) {
