   ...
   ?>
    <?= GridView::widget([
        ...
        'columns' => [
            ...
            //array('attribute'=>'ngroup_id', 'label'=>'设备池','enableSorting'=>false, 'content' => function($model, $key, $index, $column) { return Html::a($model->getNodeGname($model['ngroup_id']), Url::to(['dcmd-node-group/view', 'id'=>$model['ngroup_id']]));}),
            array('attribute'=>'ngroup_name', 'label'=>'设备池', 'value' => 'dcmd_node_group.ngroup_name', 'content'=>function($model, $key, $index, $column) { return Html::a($model->getNodeGname($model['ngroup_id']), Url::to(['dcmd-node-group/view', 'id'=>$model['ngroup_id']]));}),
            ...
            array('attribute'=>'ip', 'label'=>'版本','filter'=>false, 'enableSorting'=>false, 'content'=>function($model, $key, $index, $column) { return $model->getAgentVersion($model['ip']);}),
            array('attribute'=>'public_ip', 'label'=>'公网IP', 'enableSorting'=>false),
            array('attribute'=>'sid', 'label'=>'设备序列号', 'enableSorting'=>false),
