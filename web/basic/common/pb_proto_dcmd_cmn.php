<?php
/**
 * Auto generated from dcmd_cmn.proto at 2015-01-07 11:09:41
 *
 * dcmd_api package
 */
...
final class Dcmd_api_DcmdMsgType
{
    ...
    const MTYPE_UI_SCRIPTS = 77;
    const MTYPE_UI_SCRIPTS_R = 78;
    const MTYPE_UI_SCRIPT_INFO = 79;
    const MTYPE_UI_SCRIPT_INFO_R = 80;
 ...
 * UiScriptType enum
 */
final class Dcmd_api_UiScriptType
{
    const SCRIPT_TYPE_TASK_CMD = 1;
    const SCRIPT_TYPE_OPR_CMD = 2;
    const SCRIPT_TYPE_CRON = 3;
    const SCRIPT_TYPE_MONITOR = 4;
    const SCRIPT_TYPE_SVR = 5;
