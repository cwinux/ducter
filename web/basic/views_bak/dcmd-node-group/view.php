...
<div class="dcmd-node-view" id="dcmd-node"  >
    <?= GridView::widget([
        ...
        'columns' => [
            ...
            array('attribute'=>'public_ip', 'label'=>'公网IP','filter'=>false, 'enableSorting'=>false),
            array('attribute'=>'bend_ip', 'label'=>'带外IP', 'filter'=>false, 'enableSorting'=>false),
...
<div class="dcmd-node-group-view" id="dcmd-node-group"  style="display:none" >
    <?= DetailView::widget([
        ...
        'attributes' => [
            ...
            array('attribute' => 'location', 'label' => '区域'),
            array('attribute' => 'gtype', 'label' => '类别'),
            array('attribute' => 'operators', 'label' => '运营商'),
            array('attribute' => 'mach_room', 'label' => '机房'),
            array('attribute' => 'manage_ip', 'label' => '管理地址'),
            array('attribute' => 'net', 'label' => '虚拟机实例地址'),
...
<script>
  document.getElementById("<?php echo 'dcmd-node-l'; ?>").click();
</script>
