...
<div class="dcmd-node-form">
    ...
    <?= $form->field($model, 'ip')->textInput(['maxlength' => 16, "$disabled"=>"true", 'onblur' => "javascript:getAgentHostName()"])->label('服务器IP') ?>
    ...
    <?= $form->field($model, 'server_brand')->dropDownList($dev_type)->label('设备类型') ?>
