...
class DcmdServicePoolSearch extends DcmdServicePool
{
    ...
    public function rules()
    {
        return [
            ...
            [['svr_pool', 'repo', 'env_ver', 'comment', 'utime', 'ctime','env_md5','env_passwd','pool_group'], 'safe'],
        ];
    }
    ...
    public function search($params)
    {
        ...
        $query = DcmdServicePool::find()->where($svr_pool_con)->orderBy('pool_group');
        ...
        $query->andFilterWhere(['like', 'svr_pool', $this->svr_pool])
            ...
            ->andFilterWhere(['like', 'pool_group', $this->pool_group])
