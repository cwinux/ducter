 ...
 */
class DcmdResDnsSearch extends DcmdResDns
{
    /**
     * @inheritdoc
     */
    public function rules()
    {
        return [
            ...
            [['res_id','contact','I2','I3','I4','I5','tag','res_name','name','comment','ctime','stime'], 'safe'],
        ];
    }
    ...
    {
        $con_str = "";
        $query = DcmdResDns::find()->where($con_str)->orderBy('res_id');
