 ...
 */
class DcmdAppServicePoolSearch extends DcmdServicePool
{
    /**
     * @inheritdoc
     */
    ...
    public function rules()
    {
        return [
            ...
            [['svr_pool', 'app_name','repo', 'env_ver', 'comment', 'utime', 'ctime'], 'safe'],
        ];
    }
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere(['like', 'svr_pool', $this->svr_pool])
            ->andFilterWhere(['like', 'dcmdApp.app_name', $this->app_name])
