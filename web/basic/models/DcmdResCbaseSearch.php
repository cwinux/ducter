 ...
 */
class DcmdResCbaseSearch extends DcmdResCbase
{
    /**
     * @inheritdoc
     */
    public function rules()
    {
        return [
            ...
            [['res_id','contact','cluster','res_name','bucket','comment','ctime','stime'], 'safe'],
        ];
    }
    ...
    {
        $con_str = "";
        $query = DcmdResCbase::find()->where($con_str)->orderBy('res_id');
