 ...
 */
class DcmdResMqSearch extends DcmdResMq
{
    /**
     * @inheritdoc
     */
    public function rules()
    {
        return [
            ...
            [['res_id','contact','cluster','res_name','queue','comment','ctime','stime'], 'safe'],
        ];
    }
    ...
    {
        $con_str = "";
        $query = DcmdResMq::find()->where($con_str)->orderBy('res_id');
