 ...
 */
class DcmdAppUploadErrorSearch extends DcmdAppUploadError
{
    /**
     * @inheritdoc
     */
    public function rules()
    {
        return [
            ...
            [['accept_time', 'upload_time','upload_type','errmsg', 'upload_host','app_name','svr_name','svr_pool','upload_username','accept_username','version','md5','src_path','pkg_file'], 'safe'],
        ];
    }
...
#          $svr_con .=")";
#        }
        $query = DcmdAppUploadError::find()->where($svr_con)->orderBy('upload_time');
