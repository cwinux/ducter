...
/**
 * DcmdTaskHistorySearch represents the model behind the search form about `app\models\DcmdTaskHistory`.
 */
class DcmdTaskHistorySearch extends DcmdTaskHistory
{
    /**
     * @inheritdoc
     */
    public function rules()
    {
        return [
            ...
            [['task_name', 'task_cmd', 'depend_task_name', 'svr_name', 'svr_path', 'tag', 'err_msg', 'task_arg', 'comment', 'utime', 'ctime','tag_md5','tag_passwd'], 'safe'],
        ];
    }
