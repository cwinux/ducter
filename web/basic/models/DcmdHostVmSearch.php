 ...
 */
class DcmdHostVmSearch extends DcmdHostVm
{
    /**
     * @inheritdoc
     */
    public function rules()
    {
        return [
            [['id'], 'integer'],
            [['vm_uuid', 'utime', 'cpu', 'memory', 'disk', 'state', 'app_name', 'flavor_name', 'image_name', 'host_name', 'host_ip', 'vm_ip'], 'safe'],
        ];
    }
    ...
    public function search($params)
    {
     /*   $con_str = "";
        ...
        $query = DcmdHostVm::find()->orderBy("host_ip");
