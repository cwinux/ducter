 ...
 */
class DcmdResMongoSearch extends DcmdResMongo
{
    /**
     * @inheritdoc
     */
    public function rules()
    {
        return [
            ...
            [['res_id','contact','cluster','res_name','comment','ctime','stime'], 'safe'],
        ];
    }
    ...
    {
        $con_str = "";
        $query = DcmdResMongo::find()->where($con_str)->orderBy('res_id');
