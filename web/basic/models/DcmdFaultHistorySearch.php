 ...
 */
class DcmdFaultHistorySearch extends DcmdFaultHistory
{
    /**
     * @inheritdoc
     */
    public function rules()
    {
        return [
            [['fault_id'], 'integer'],
            [['app_name', 'host_ip', 'host_fault', 'vm_uuid', 'vm_ip', 'vm_fault', 'confirm_user', 'erase_user'], 'safe'],
        ];
    }
    ...
    {
        $con_str = "";
        $query = DcmdFaultHistory::find()->where($con_str)->orderBy('fault_id');
