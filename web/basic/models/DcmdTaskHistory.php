...
/**
 * This is the model class for table "dcmd_task_history".
 *
 ...
 */
class DcmdTaskHistory extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    public function rules()
    {
        return [
            ...
            [['is_deploy','depend_task_id', 'svr_id', 'update_env', 'update_tag', 'state', 'freeze', 'valid', 'pause', 'concurrent_rate', 'timeout', 'auto', 'process', 'opr_uid'], 'integer'],
            [['task_arg'], 'string'],
            [['utime', 'ctime'], 'safe'],
