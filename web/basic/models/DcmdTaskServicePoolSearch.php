...
/**
 * DcmdTaskServicePoolSearch represents the model behind the search form about `app\models\DcmdTaskServicePool`.
 */
class DcmdTaskServicePoolSearch extends DcmdTaskServicePool
{
    /**
     * @inheritdoc
     */
    public function rules()
    {
        return [
            ...
            [['task_cmd', 'svr_pool', 'env_ver', 'repo', 'run_user', 'utime', 'ctime','env_md5','env_passwd'], 'safe'],
        ];
    }
