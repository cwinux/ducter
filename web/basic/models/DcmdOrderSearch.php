 ...
 */
class DcmdOrderSearch extends DcmdOrder
{
    /**
     * @inheritdoc
     */
    public function rules()
    {
        return [
            ...
            [['bill_id', 'action', 'args', 'callback', 'errmsg', 'manual', 'apply_user', 'apply_time', 'ctime', 'utime'], 'safe'],
        ];
    }
    ...
    {
        $con_str = "";
        $query = DcmdOrder::find()->where($con_str)->orderBy('apply_time');
