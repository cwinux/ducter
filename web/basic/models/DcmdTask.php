...
class DcmdTask extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['task_cmd', 'depend_task_id', 'depend_task_name', 'app_id', 'app_name', 'svr_id', 'svr_name', 'svr_path', 'update_env', 'update_tag', 'state', 'node_multi_pool', 'freeze', 'valid', 'pause', 'concurrent_rate', 'timeout', 'auto', 'process', 'utime', 'ctime', 'opr_uid'], 'required'],
            [['is_deploy','depend_task_id', 'svr_id', 'update_env', 'update_tag', 'state', 'freeze', 'valid', 'pause', 'concurrent_rate', 'timeout', 'auto', 'process', 'opr_uid', 'node_multi_pool'], 'integer'],
            [['task_arg'], 'string'],
            [['utime', 'ctime'], 'safe'],
            [['svr_path'], 'match', 'pattern'=>'/^[a-zA-Z0-9-_\/]+$/', 'message'=>'只可包含[a-z,A-Z,0-9,-_\/]字符'],
            ///[['task_name'], 'match', 'pattern'=>'/^[a-zA-Z0-9_]+$/', 'message'=>'只可包含[a-z,A-Z,0-9,_]字符'],
            [['task_name', 'tag_passwd','depend_task_name', 'svr_name', 'tag'], 'string', 'max' => 128],
            [['task_cmd','tag_md5'], 'string', 'max' => 64],
