 ...
 */
class DcmdResRedisSearch extends DcmdResRedis
{
    /**
     * @inheritdoc
     */
    public function rules()
    {
        return [
            ...
            [['res_id','contact','cluster','res_name','port','comment','ctime','stime'], 'safe'],
        ];
    }
    ...
    {
        $con_str = "";
        $query = DcmdResRedis::find()->where($con_str)->orderBy('res_id');
