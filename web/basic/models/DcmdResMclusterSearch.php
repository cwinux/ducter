 ...
 */
class DcmdResMclusterSearch extends DcmdResMcluster
{
    /**
     * @inheritdoc
     */
    ...
    {
        return [
            [['res_order','is_public','comp_id','state','opr_uid','port'], 'integer'],
            [['res_id','contact','cluster','res_name','db','comment','ctime','stime'], 'safe'],
        ];
    }
    ...
    {
        $con_str = "";
        $query = DcmdResMcluster::find()->where($con_str)->orderBy('res_id');
