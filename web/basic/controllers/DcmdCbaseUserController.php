...
use app\models\DcmdCbsBussinessSearch;
 ...
 */
class DcmdCbaseUserController extends Controller
{
    ...
    public function actionIndex()
    {
        ...
        $searchModel = new DcmdCbsBussinessSearch();
    ...
    {
        $model = new DcmdCbsBussiness();
        if (Yii::$app->request->post()) {
          if ($model->load(Yii::$app->request->post()) && $model->save()) {
            $this->oprlog(1, "insert cbase user:".$model->bussiness);
