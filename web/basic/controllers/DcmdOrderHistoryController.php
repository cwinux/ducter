...
use app\models\DcmdOrderHistorySearch;
 ...
 */
class DcmdOrderHistoryController extends Controller
{
    ...
    {
        $searchModel = new DcmdOrderHistorySearch();
   ...
   public function actionReject() {
    ...
    public function actionDeleteAll()
    {
      ...
      foreach($select as $k=>$id) {
        $model = $this->findModel($id);
        $this->oprlog(3, "delete order history:".$model->order_id);
        $suc_msg .=$model->order_id.':删除成功<br>';
        $model->delete();
      }
    ...
    {
        if (($model = DcmdOrderHistory::findOne($order_id)) !== null) {
            return $model;
        } else {
