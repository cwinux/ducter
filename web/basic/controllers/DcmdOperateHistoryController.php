 ...
 */
class DcmdOperateHistoryController extends Controller
{
    ...
    {
        $searchModel = new DcmdVmOplogSearch();
   ...
   public function actionReject() {
    ...
    public function actionDeleteAll()
    {
      ...
      foreach($select as $k=>$id) {
        $model = $this->findModel($id);
        $this->oprlog(3, "delete operate history:".$model->id);
    ...
    {
        if (($model = DcmdVmOplog::findOne($id)) !== null) {
            return $model;
        } else {
