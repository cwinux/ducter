 ...
 */
class DcmdCbasePoolController extends Controller
{
    ...
    /*    $con['DcmdServicePoolNodeSearch'] = array('svr_pool_id'=>$id);
        ...
        $poolModel = DcmdCbasePool::findOne($id);
    ...
    public function actionCreate($app_id)
    {
        ...
        if (Yii::$app->request->post() && $model->load(Yii::$app->request->post())) {
          if($model->save()) {
            $this->oprlog(1,"insert service pool:".$model->pool_name);
          ...
          return $this->redirect(array('dcmd-cbase-pool/view', 'id'=>$id));
        } 
        $model = new DcmdCbasePool();
        $model->app_id = $app_id;
    ...
    public function actionDelete($id, $svr_id=NULL)
    {
        ...
        return $this->redirect(array('dcmd-cbse-pool/view', 'id'=>$id));
    }
