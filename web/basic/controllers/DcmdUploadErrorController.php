...
use app\models\DcmdAppUploadError;
use app\models\DcmdAppUploadErrorSearch;
 ...
 */
class DcmdUploadErrorController extends Controller
{
    ...
    {
        $searchModel = new DcmdAppUploadErrorSearch();
