 ...
 */
class DcmdNetworkController extends Controller
{
    ...
    {
        $searchModel = new DcmdIdcNetworkSearch();
...
//      return strlen($blp);
    ...
    public function actionDeleteAll()
    {
      ...
      foreach($select as $k=>$id) {
        $model = $this->findModel($id);
        $this->oprlog(3, "delete network info:".$model->segment);
        $suc_msg .=$model->segment.':删除成功<br>';
        $model->delete();
      }
