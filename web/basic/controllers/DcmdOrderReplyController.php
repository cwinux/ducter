...
use app\models\DcmdVmOrderReplySearch;
 ...
 */
class DcmdOrderReplyController extends Controller
{
    ...
    {
        $searchModel = new DcmdVmOrderReplySearch();
   ...
   public function actionReject() {
    ...
    public function actionDeleteAll()
    {
      ...
      foreach($select as $k=>$id) {
        $model = $this->findModel($id);
        $this->oprlog(3, "delete oeder reply:".$model->id);
    ...
    {
        if (($model = DcmdVmOrderReply::findOne($id)) !== null) {
            return $model;
        } else {
