...
use app\models\DcmdVmOplogSearch;
use app\models\DcmdVmOrderreplyHistory;
use app\models\DcmdVmOrderreplyHistorySearch;
use app\models\DcmdAlarmHistory;
use app\models\DcmdAlarmHistorySearch;
 ...
 */
class DcmdOrderreplyHistoryController extends Controller
{
    ...
    {
        $searchModel = new DcmdVmOrderreplyHistorySearch();
   ...
   public function actionReject() {
    ...
    public function actionDeleteAll()
    {
      ...
      foreach($select as $k=>$id) {
        $model = $this->findModel($id);
        $this->oprlog(3, "delete oeder reply history:".$model->id);
    ...
    {
        if (($model = DcmdVmOrderreplyHistory::findOne($id)) !== null) {
            return $model;
        } else {
