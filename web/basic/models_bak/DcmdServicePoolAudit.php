 ...
 */
class DcmdServicePoolAudit extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return 'dcmd_service_pool_audit';
    }
    ...
    {
        return [
            [['svr_pool_id', 'svr_id', 'nid', 'app_id', 'ip', 'utime', 'ctime', 'action', 'opr_uid'], 'required'],
   ...
   {
     $query =  DcmdUser::findOne(['uid'=>$uid]);
