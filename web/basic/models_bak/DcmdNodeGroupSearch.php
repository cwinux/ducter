...
class DcmdNodeGroupSearch extends DcmdNodeGroup
{
    ...
    public function rules()
    {
        return [
            ...
            [['ngroup_name', 'comment', 'location', 'gtype', 'operators', 'mach_room', 'manage_ip', 'net', 'utime', 'ctime'], 'safe'],
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere(['like', 'ngroup_name', $this->ngroup_name])
            ...
            ->andFilterWhere(['like', 'gtype', $this->gtype])
            ->andFilterWhere(['like', 'operators', $this->operators])
            ->andFilterWhere(['like', 'mach_room', $this->mach_room])
            ->andFilterWhere(['like', 'manage_ip', $this->manage_ip]);
        return $dataProvider;
    }
}
